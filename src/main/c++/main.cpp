...
int runApp() {
    std::string cmd = "\"" + workingdir() +  "/" + javaFile + "\"" + " -jar --enable-preview --enable-native-access=be.yildizgames.retro.player.emulator.libretro,be.yildizgames.module.controller.sdl play50hz-player.jar";
